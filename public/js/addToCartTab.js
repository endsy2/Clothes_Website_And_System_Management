document.addEventListener('DOMContentLoaded', () => {
    ...
    cartOverLay.addEventListener('click', (e) => {
        // Make sure it's not a click inside the cart itself
    ...
    closeBtn.addEventListener('click', closeCartTab);
    ...
    function renderCartItems() {
        ...
        cart.forEach(item => {
            ...
            quantitySelect.addEventListener('change', (e) => {
                ...
                renderCartItems();
                closeCartTab(); // ✅ Auto-close on quantity change
            });
            ...
            deleteBtn.addEventListener('click', (e) => {
                ...
                localStorage.setItem('cart', JSON.stringify(updatedCart));
                renderCartItems();
                closeCartTab(); // ✅ Auto-close on delete
            });
        });
        ...
        // ✅ Auto-close on "Proceed to Checkout"
        setTimeout(() => {
            const checkoutBtn = document.querySelector('a[href="/checkout"]');
            if (checkoutBtn) {
                checkoutBtn.addEventListener('click', closeCartTab);
            }
        }, 0);
    }
});
