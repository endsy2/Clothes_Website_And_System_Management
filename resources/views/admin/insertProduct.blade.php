<x-admin-layout>
    ...
    <form action="/admin/add-product" id="form-input" method="POST" enctype="multipart/form-data"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
                <input type="text" name="stock" placeholder="Stock Quantity"
                    class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:border-black"
                    required>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div>
                <select name="product_type_name"
                    ...
                    <option value="{{ $productType['product_type_name'] }}">{{ $productType['product_type_name'] }}
                    </option>
                    @endforeach
                </select>
                <x-error-form name="product_type_name" />
            </div>
            ...
            <div>
                <select name="discount"
                    ...
                    <option value="{{ $discount['discount_name'] }}" @if(old('discount')==$discount['discount_name'])
                        selected @endif>
