<x-admin-layout>
    ...
    <form action={{ route('admin.add-product-variant') }} method="POST" enctype="multipart/form-data" id="form-input"
        class="space-y-5 bg-white py-6 px-10 rounded-lg shadow-md max-w-5xl mx-auto">
        @csrf

        <h2 class="text-2xl font-semibold text-gray-800 border-b pb-2">Insert Product Variants</h2>
        ...
        <!-- Submit Button -->
        <div class="pt-4">
            <input type="submit" value="Add Product Variant"
